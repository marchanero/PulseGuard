...
router.post('/', async (req, res) => {
  try {
    const { name, type, url, host, port, description, checkInterval, isActive, isPublic, tags, headers } = req.body;
    
    console.log('Creando servicio:', { name, type, url, host, port, tags, headers });
